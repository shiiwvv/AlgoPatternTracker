      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-sm text-gray-500 mt-4 max-w-xs">
              Solve. Debug. Learn. Your personal dashboard for tracking algorithmic patterns and daily problem-solving.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-sm font-semibold text-gray-100 uppercase tracking-wider">
                Resources
              </h2>
              <ul className="text-gray-400 font-medium space-y-4">
                ...
                <li>
                  <Link to="/pattern" className="hover:text-green-500 transition-colors">
                    Patterns Library
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="text-gray-400 font-medium space-y-4">
                <li>
                  {/* Swap this href with your actual GitHub later */}
                  <a
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center">
            © {new Date().getFullYear()} AlgoTracker. Built for mastery.
          </span>
          <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
            {/* Social Icons - Updated hover states to match the theme */}
            <Link to="#" className="text-gray-500 hover:text-green-500 transition-colors">
